...
| ----- | ---------------------------------------------- | ---- | ----------- |
| WP-01 | Truthful returns: persistence failures surface | S    | Done        |
| WP-02 | One lookup path, one dialect, complete facade  | S    | Done        |
| WP-03 | Notification and watcher coherence             | S    | Done        |
| WP-04 | Location model: precedence, domain, isolation  | S    | Done        |
| WP-05 | Surface and dependency pruning                 | S    | Done        |
| WP-06 | Downstream verification and release            | S    | Not Started |
