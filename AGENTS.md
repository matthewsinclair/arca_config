...
arca_config -- an Intent project. See `CLAUDE.md` for Claude-specific overlay.
...
- **in-essentials** -- Core Intent workflow rules for steel threads, work packages, agents, skills, and session management
